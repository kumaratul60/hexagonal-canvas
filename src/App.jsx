...
function init() {
  ...
  const myDiagram = goObject(go.Diagram, {
  ...
  myDiagram.nodeTemplate = goObject(
    go.Node,
    "Auto",
    {
  ...
  myDiagram.nodeTemplate.selectionAdornmentTemplate = goObject(
    go.Adornment,
    "Spot",
    goObject(
      go.Panel,
  ...
  myDiagram.linkTemplate = goObject(
  ...
  // fill label inside node with the current time for not shows empty text
  function getTime() {
  ...
  return (
    <div className="App">
      <ReactDiagram
        ...
        nodeDataArray={[
          { key: 0, text: "React", loc: "0 0" },
          { key: 1, text: "javaScript", loc: "180 0" },
          { key: 2, text: "HTML-CSS", loc: "0 180" },
          { key: 3, text: "Next JS", loc: "180 180" },
          { key: 4, text: "firebase", loc: "180 0" },
        ]}
